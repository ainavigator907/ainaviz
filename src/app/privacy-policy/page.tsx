...
export const metadata: Metadata = {
  title: "プライバシーポリシー | AINaviz",
  description: "AINaviz のプライバシーポリシー（個人情報保護方針）について。",
};
      ...
      <main className="section" style={{ minHeight: "80vh" }}>
        <div className="container" style={{ maxWidth: "800px" }}>
          ...
          <div className="card" style={{ padding: "clamp(1.5rem, 5vw, 3rem)", lineHeight: "1.8" }}>
            <p>
              AINaviz（以下、「当サイト」とします）は、本ウェブサイト上で提供するサービスにおける、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」とします）を定めます。
            </p>
